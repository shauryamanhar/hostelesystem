...
<div class="container">
    ...
    <div class="well"> 
		 ...
		 <form action="DeleteComplain" method="post">
		 	<button class="button btn btn-danger" type="submit" style="float:right">DELETE</button>
		 </form>
		 
		 <form action="ShowComplainController" method="post">
		  <button class="button btn btn-primary" type="submit" style="float:right">SHOW</button>
		 </form>
		 
		 
		  <form action="ShowAllMess" method="post">
		 	<button class="button btn btn-primary" type="submit" style="float:left">MESS</button>
		 </form>
		  <form action="ShowAllElectric" method="post">
		 	<button class="button btn btn-primary" type="submit" style="float:left">ELECTRIC</button>
		  </form>
		  <form action="ShowAllCleanliness" method="post">
			<button class="button btn btn-primary" type="submit" style="float:left">CLEAN</button>
		  </form>
<br>
<hr>
<%--
