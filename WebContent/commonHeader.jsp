								...
								<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
									<ul class="nav navbar-nav">
										...
										<li class="dropdown">
											...
											<ul class="dropdown-menu">
												<li>
													<a href="#">A&nbsp;<small>MANIPAL</small></a>
												</li>
												<li>
													<a href="#">B&nbsp;<small>CHIRTRAKOT</small></a>
												</li>
												<li>
													<a href="#">C&nbsp;<small>TIRATHGARH</small></a>
												</li>
												<li>
													<a href="#">D&nbsp;<small>MALHAR</small></a>
												</li>
												<li>
													<a href="#">H&nbsp;<small>SIRPUR</small></a>
												</li>
												<li>
													<a href="#">F&nbsp;<small>KOTUMSAR</small></a>
												</li>
												<li role="separator" class="divider"></li>
												<li>
													<a href="#">E</a>
