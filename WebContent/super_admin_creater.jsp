...
if(session.getAttribute("allAdminList")==null){
	SuperAdminDao superAdminDao = new SuperAdminDaoImpl();
	allAdminList = superAdminDao.getAllAdmin();
}else{
	allAdminList = (List<Admin>)session.getAttribute("allAdminList");
}
session.removeAttribute("allAdminList");
int count=1;
%>
    	...
    	<table class="table table-bordered table-hover table-striped">
    		...
    		<%for(Admin admin : allAdminList){ %>
    			<tr>
    				...
    				<td style="text-align: center;">
    					<a href="SuperAdminDeleteController?adminId=<%=admin.getAdminId()%>">
			  ...
			  <div class="modal-dialog">
			    ...
			    <div class="modal-content">
			      ...
			      <div class="modal-body">
			        <p>
			        <form class="form-signin" action="SuperAdminAddController" method="POST">
						...
						<br>
						<input type="text" class="form-control" id="" name="password" required="" autofocus=""  placeholder="Password"/>
