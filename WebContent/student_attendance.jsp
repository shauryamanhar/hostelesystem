					  ...
					  <tr>
					    ...
					    <td>
					    	 ...
					    	 <div class="form-group" style="float:left;width:32%;margin:left;">
								  ...
								  <input type="radio" name="<%=hostelID%>" value="1" checked> Present<br>
					      		<%}else{ %>
								  <input type="radio" name="<%=hostelID%>" value="1" disabled> Present<br>
					      		<%} %>
							    <%if(allLeaveList.contains(hostelID)!=true){%>
								  <input type="radio" name="<%=hostelID%>" value="0" > Absent<br>
					      		<%}else{ %>
								  <input type="radio" name="<%=hostelID%>" value="0" disabled> Absent<br>
					      		<%} %>
					      		<%if(allLeaveList.contains(hostelID)==true){%>
								  <input type="radio" name="<%=hostelID%>" value="2" checked> Leave<br>
					      		<%}else{ %>
								  <input type="radio" name="<%=hostelID%>" value="2" disabled> Leave<br>
					      		<%} %>
