...
%>
<%
Boolean superAdminLoginCheck = false;
if(session.getAttribute("superAdminLoginCheck")==null || (Boolean)session.getAttribute("superAdminLoginCheck")==false){
	response.sendRedirect("super_admin_login.jsp");
}
superAdminLoginCheck=true;
%>    
...
<body data-spy="scroll" data-target=".navbar" data-offset="150">
				<div class="container" style="position: relative;font-family: Arial;width:100%;">
					<img src="images//ii.png" alt="Nature" style="width:100%;-webkit-filter: blur(2px); filter: blur(5px);">
						...
						<%
						System.out.println("super---check before if "+superAdminLoginCheck);
						if(superAdminLoginCheck==true){
						%>
						<ul class="nav navbar-nav navbar-right">
							<li class="dropdown">
								<a href="" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">super admin&nbsp;<span class="glyphicon glyphicon-cog"></span></a>
								<ul class="dropdown-menu" style="margin-top: 0px;color:black;max-width: 200px;width:200px;word-wrap:break-word;">
									<li>
										<div class="well" style="padding :15px;margin:8px;">
											<b><small>logged as super administrator</small></b>
											<h4>ID: <%=session.getAttribute("superAdminId") %></h4>
										</div>
									</li>
									<li class="logout">
										<a href="SuperAdminLogoutController"><span style="color: red;">log out&nbsp;<span class="glyphicon glyphicon-log-out" style="font-size: 15px;"></span></a>
									</li>
								</ul>
							</li>
						</ul>
